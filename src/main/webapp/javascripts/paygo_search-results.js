$(document).ready(function () {
    ...
    $("#login-submit-order").click(login_submit_handler)
    $("form#logIn-form_order :input").each(function(){
    ...
    $("#register-submit-order").click(register_submit_handler);
    $("form#registration-form-order :input").each(function(){
        var input = $(this); // This is the jquery object of the input, do what you will
        input.keydown(function(event){
            if (event.keyCode == 13){
